...
help :-
	...
	write('*    6. status.        : See your status                                                         *'),nl,
    write('**************************************************************************************************'),nl.
help :-
    inStore,!,
    write('**************************************************************************************************'),nl,
	...
	write('*     8. unequip(armor).         : Unequip your armor                                            *'),nl,
	write('*     9. unequip(accessory).     : Unequip your accessory                                        *'),nl,
	write('*    10. inventory.              : Show inventory                                                *'),nl,
	write('*    11. drop(item_name, count). : Drop count item_name                                          *'),nl,
	write('*    12. eqStatus(item_name).    : See the details of an equipment                               *'),nl,
    write('**************************************************************************************************'),nl.
help :-
    gameStarted,!,
    write('**************************************************************************************************'),nl,
	...
	write('*                   eqStatus(item_name).    -> See the details of an equipment                   *'),nl,
